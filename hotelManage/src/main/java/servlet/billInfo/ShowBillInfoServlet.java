...
@WebServlet(name = "ShowBillInfoServlet",urlPatterns = "/dao.show_billInfo")
public class ShowBillInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = billInfoService.queryBillInfo(info,index,pageSize);
