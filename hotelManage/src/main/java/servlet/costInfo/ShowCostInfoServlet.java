...
@WebServlet(name = "ShowCostInfoServlet",urlPatterns = "/dao.show_costInfo")
public class ShowCostInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = costInfoService.queryCostInfo(info,index,pageSize);

        int Num = costInfoService.getCostInfoCount(info);
