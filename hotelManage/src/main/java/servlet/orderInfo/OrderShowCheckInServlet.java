...
@WebServlet(name = "OrderShowCheckInServlet",urlPatterns = "/dao.show_checkin_order")
public class OrderShowCheckInServlet extends HttpServlet {
...
// 设置字符集
        ...
        List<Map<String ,String >> result = orderInfoService.queryCheckinInfo(info,index,pageSize);
        int Num = orderInfoService.getCheckinInfoCount(info);
