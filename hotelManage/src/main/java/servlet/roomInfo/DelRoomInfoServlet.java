...
@WebServlet(name = "DelRoomInfoServlet",urlPatterns = "/dao.del_roomInfo")
public class DelRoomInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String info =request.getParameter("room_id");
        if (roomInfoService.deleteRoomInfo(user_info,info)>0){
