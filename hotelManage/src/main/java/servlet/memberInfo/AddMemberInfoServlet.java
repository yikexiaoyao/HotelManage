...
@WebServlet(name = "AddMemberInfoServlet",urlPatterns = "/dao.add_memberInfo")
public class AddMemberInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (0 < memberInfoService.insertMemberInfo(user_info, info)) {
