...
@WebServlet(name = "DelMemberInfoServlet",urlPatterns = "/dao.del_memberInfo")
public class DelMemberInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     String info = request.getParameter("member_id");
        if (memberInfoService.deleteMemberInfo(user_info,info)>0){
