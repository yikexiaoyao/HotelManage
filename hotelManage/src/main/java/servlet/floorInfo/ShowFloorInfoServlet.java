...
@WebServlet(name = "ShowFloorInfoServlet",urlPatterns = "/dao.show_floorInfo")
public class ShowFloorInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = floorInfoService.queryFloorInfo(info,index,pageSize);

        int Num = floorInfoService.getFloorInfoCount(info);
