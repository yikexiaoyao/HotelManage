...
@WebServlet(name = "ShowGoodsInfoServlet",urlPatterns = "/dao.show_goodsInfo")
public class ShowGoodsInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = goodsInfoService.queryGoodsInfo(info,index,pageSize);

        int Num = goodsInfoService.getGoodsInfoCount(info);
