...
@WebServlet(name = "DelUserInfoServlet",urlPatterns = "/dao.del_userInfo")
public class DelUserInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       String info =request.getParameter("user_id");
        if (userInfoService.deleteUserInfo(user_info,info)>0){
