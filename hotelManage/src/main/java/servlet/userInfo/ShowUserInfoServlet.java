...
@WebServlet(name = "ShowUserInfoServlet",urlPatterns = "/dao.show_userInfo")
public class ShowUserInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = userInfoService.queryUserInfo(info,index,pageSize);

        int Num = userInfoService.getUserInfoCount(info);
