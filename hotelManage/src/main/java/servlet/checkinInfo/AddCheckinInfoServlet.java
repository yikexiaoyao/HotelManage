...
@WebServlet(name = "AddCheckinInfoServlet",urlPatterns = "/dao.add_checkinInfo")
public class AddCheckinInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (0 < checkinInfoService.insertCheckinInfo(user_info, info)) {
