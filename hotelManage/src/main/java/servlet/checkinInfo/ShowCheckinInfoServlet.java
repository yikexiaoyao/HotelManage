...
@WebServlet(name = "ShowCheckinInfoServlet",urlPatterns = "/dao.showCheckinInfo")
public class ShowCheckinInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = checkinInfoService.queryCheckinInfo(info,index,pageSize);
