...
@WebServlet(name = "BookingCustomersServlet",urlPatterns = "/dao.bookingcustomers_reportform")
public class BookCustomersServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = orderInfoService.queryBookCustomersInfo(info,index,pageSize);

        int Num = orderInfoService.getOrderInfoCount(info);
