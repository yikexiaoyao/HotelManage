...
@WebServlet(name = "ShowTodayBillInfoServlet",urlPatterns = "/dao.showtodaybillInfo_reportform")
public class ShowTodayBillInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = billInfoService.queryTodayBillInfoReportForm(info,index,pageSize);

        int Num = billInfoService.getBillInfoCount(info);
