...
@WebServlet(name = "ShowRoomTypeServlet",urlPatterns = "/dao.show_roomType")
public class ShowRoomTypeServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String ,String >> result = roomTypeService.queryRoomType(info,index,pageSize);

        int Num = roomTypeService.getRoomTypeCount(info);
